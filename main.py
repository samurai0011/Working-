...
photologo = 'https://graph.org/file/84d7a53ac7a94468b357e-9209ae642ec739f3f4.jpg'
photoyt = 'https://graph.org/file/84d7a53ac7a94468b357e-9209ae642ec739f3f4.jpg'
photocp = 'https://graph.org/file/84d7a53ac7a94468b357e-9209ae642ec739f3f4.jpg'
...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/+b3WJQhx86sAwZDA9"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+b3WJQhx86sAwZDA9"),
        ],
    ]
)
# Image URLs for the random image feature
image_urls = [
    "https://graph.org/file/84d7a53ac7a94468b357e-9209ae642ec739f3f4.jpg",
    "https://graph.org/file/84d7a53ac7a94468b357e-9209ae642ec739f3f4.jpg",
    # Add more image URLs as needed
]
cookies_file_path= "youtube_cookies.txt"
@bot.on_message(filters.command(["SAMURAI"]))
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        "𝗖𝗢𝗡𝗚𝗥𝗔𝗧𝗨𝗟𝗔𝗧𝗜𝗢𝗡𝗦 𝗬𝗢𝗨 𝗔𝗥𝗘 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗕𝗢𝗧 𝗨𝗦𝗜𝗡𝗚 ➾ 𝗦𝗔𝗠𝗨𝗥𝗔𝗜 𝗕𝗢𝗧:\n┣\n"
        "┣⪼𝟭. 𝗦𝗘𝗡𝗗 /SAMURAI- 𝗧𝗢 𝗖𝗛𝗘𝗖𝗞 𝗕𝗢𝗧 \n┣\n"
        "┣⪼𝟮. 𝗦𝗘𝗡𝗗 /HITMAN- 𝗙𝗢𝗥 𝗘𝗫𝗧𝗥𝗔𝗖𝗧𝗘𝗗 𝗬𝗢𝗨𝗥𝗦 𝗧𝗫𝗧 𝗙𝗜𝗟𝗘 \n┣\n"
        "┣⪼𝟯. 𝗦𝗘𝗡𝗗 /CP -𝗙𝗢𝗥 𝗦𝗧𝗥𝗘𝗔𝗠 𝗬𝗢𝗨𝗥𝗦 𝗧𝗫𝗧 𝗙𝗜𝗟𝗘 \n┣\n"
        )
    ) 
...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url=f"https://t.me/+b3WJQhx86sAwZDA9")]])
...
async def start_command(bot: Client, message: Message):
    ...
    caption = (
        "𝗛𝗘𝗟𝗟𝗢 𝗦𝗜𝗥!\n\n➠ 𝗜 𝗔𝗠 𝗔 𝗣𝗢𝗪𝗘𝗥𝗙𝗨𝗟 𝗧𝗫𝗧 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗥 𝗕𝗢𝗧\n\n➠ 𝗧𝗫𝗧 𝗧𝗢 𝗩𝗜𝗗𝗘𝗢 𝗔𝗡𝗗 𝗣𝗗𝗙 𝗘𝗫𝗧𝗥𝗔𝗖𝗧𝗘𝗗 𝗞𝗔𝗥 𝗦𝗔𝗞𝗧𝗘 𝗛𝗔𝗜!\n\n➠ 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 /SAMURAI\n\n➠ 𝗠𝗔𝗗𝗘 𝗕𝗬 : 𝗦𝗔𝗠𝗨𝗥𝗔𝗜 𝗕𝗢𝗧𝗦"
    )
...
@bot.on_message(filters.command(["Ruk Jao"]) )
async def restart_handler(_, m):
    await m.reply_text("𝗥𝗨𝗞 𝗚𝗔𝗬𝗔 𝗦𝗜𝗥 𝗝𝗜𝗜", True)
...
@bot.on_message(filters.command(["HITMAN"]) )
async def txt_handler(bot: Client, m: Message):
    editable = await m.reply_text(f"`𝐓𝐗𝐓 𝐅𝐈𝐋𝐄 𝐁𝐇𝐄𝐉𝐈𝐘𝐄 𝐒𝐈𝐑 𝐉𝐈𝐈`")
    input: Message = await bot.listen(editable.chat.id)
    x = await input.download()
    await input.delete(True)
    file_name, ext = os.path.splitext(os.path.basename(x))
    credit = f"𝗦𝗔𝗠𝗨𝗥𝗔𝗜 𝗕𝗢𝗧𝗦"
    pdf_count = 0
    img_count = 0
    zip_count = 0
    video_count = 0
    ...
    try:
        for i in range(arg-1, end):
            ...
            try:  
                cc = f'𝐓𝐈𝐓𝐋𝐄 » `{name} [{res}] .mp4`\n\n<pre><code>𝐂𝐎𝐔𝐑𝐒𝐄 : {b_name}</code></pre>\n\n𝐄𝐗𝐓𝐑𝐀𝐂𝐓𝐄𝐃 𝐁𝐘 » `{CR}`\n'
                cc1 = f'•——— `{a_name}` ———•\n\n[——— ✨ {str(count).zfill(3)} ✨ ———]({link0})\n\n𝐓𝐈𝐓𝐋𝐄 » `{name1} .pdf`\n\n<pre><code>𝐂𝐎𝐔𝐑𝐒𝐄: {b_name}</code></pre>\n\n𝐄𝐗𝐓𝐑𝐀𝐂𝐓𝐄𝐃 𝐁𝐘» `{CR}`\n'
                ccimg = f'•——— `{a_name}` ———•\n\n[——— ✨ {str(count).zfill(3)} ✨ ———]({link0})\n\n𝐓𝐈𝐓𝐋𝐄 » `{name1} .jpg`\n\n<pre><code>𝐂𝐎𝐔𝐑𝐒𝐄 : {b_name}</code></pre>\n\n𝐄𝐗𝐓𝐑𝐀𝐂𝐓𝐄𝐃 𝐁𝐘 » `{CR}`\n'
                ccyt = f'•——— `{a_name}` ———•\n\n[——— ✨ {str(count).zfill(3)} ✨ ———]({link0})\n\n𝐓𝐈𝐓𝐋𝐄» `{name1} .mp4`\n\n<a href="{url}">__**𝗦𝗜𝗥 𝗦𝗔𝗠𝗔𝗝𝗛 𝗝𝗔𝗘𝗡𝗚𝗘**__</a>\n\n<pre><code>𝐂𝐎𝐔𝐑𝐒𝐄 : {b_name}</code></pre>\n\n𝐄𝐗𝐓𝐑𝐀𝐂𝐓𝐄𝐃 𝐁𝐘» `{CR}`\n'
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐑𝐎𝐆𝐑𝐄𝐒𝐒 » {progress:.2f}%\n┃\n" \
                           f" 🔗𝐈𝐍𝐃𝐄𝐗 » {str(count)}/{end} : {len(links)}\n┃\n" \
                           f" 🖇️𝐑𝐄𝐀𝐌𝐀𝐈𝐍𝐈𝐍𝐆 𝐋𝐈𝐍𝐊 » {remaining_links}\n" \
                           f"━━━━━━━━━━━━━━━━━━━━━━━━\n" \
                           f"**𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃𝐈𝐍𝐆 𝐒𝐓𝐀𝐑𝐓𝐄𝐃...⏳**\n" \
                           f' 𝐂𝐑𝐄𝐃𝐈𝐓 » `{CR}`\n┃\n' \
                           f' 𝐁𝐀𝐓𝐂𝐇 𝐍𝐀𝐌𝐄 » `{b_name}`\n\n' \
                           f"━━━━━━━━━━━━━━━━━━━━━━━━\n" \
                           f"📚𝐓𝐈𝐓𝐋𝐄 » `{name}`\n┃\n" \
                           f"🍁𝐐𝐔𝐀𝐋𝐈𝐓𝐘 » {raw_text2}p\n┃\n" \
                           f'🔗𝐋𝐈𝐍𝐊» <a href="{link0}">__**Original Link**__</a>\n┃\n' \
                           f'🖇️𝐔𝐑𝐋 » <a href="{url}">__**Modified Link**__</a>\n┃\n' \
                           f'🖼️𝐓𝐇𝐔𝐌𝐁𝐍𝐀𝐈𝐋 » <a href="{raw_text6}">__**Thumb Link**__</a>\n' \
                           f"━━━━━━━━━━━━━━━━━━━━━━━━\n" \
                           f"**𝐑𝐎𝐊𝐀𝐍𝐄 𝐊𝐄 𝐋𝐈𝐘𝐄** /RUK JAO **𝐓𝐎 𝐒𝐓𝐎𝐏 𝐏𝐑𝐎𝐂𝐄𝐒𝐒**\n" \
                           f"✦𝐁𝐎𝐓 𝐌𝐀𝐃𝐄 𝐁𝐘✦ `𝐒𝐀𝐌𝐔𝐑𝐀𝐈 𝐁𝐎𝐓𝐒`"
...
async def txt_handler(bot: Client, m: Message):
    ...
    try: 
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                if ".pdf" in url or "drive" in url or ".jpg" in url or ".jpeg" in url or ".png" in url:
                    try:
                        await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐎𝐓 𝐌𝐀𝐃𝐄 𝐁𝐘✦ `𝐒𝐀𝐌𝐔𝐑𝐀𝐈 𝐁𝐎𝐓𝐒`', disable_web_page_preview=True, reply_markup=BUTTONSDOC)
                        count +=1
                    except Exception as e:
                        await m.reply_text(str(e))    
                        time.sleep(3)    
                    ...
                    try:
                        await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐎𝐓 𝐌𝐀𝐃𝐄 𝐁𝐘✦ `𝐒𝐀𝐌𝐔𝐑𝐀𝐈 𝐁𝐎𝐓𝐒`', disable_web_page_preview=True, reply_markup=BUTTONSCP)
                        count +=1
                    except Exception as e:
                        await m.reply_text(str(e))    
                        time.sleep(3)    
                    ...
                    try:
                        await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐎𝐓 𝐌𝐀𝐃𝐄 𝐁𝐘✦ `𝐒𝐀𝐌𝐔𝐑𝐀𝐈 𝐁𝐎𝐓𝐒`', disable_web_page_preview=True, reply_markup=BUTTONSYT)
                        count +=1
                    except Exception as e:
                        await m.reply_text(str(e))    
                        time.sleep(3)    
                    ...
                    Show = f"<pre><code>⚡Dᴏᴡɴʟᴏᴀᴅ Sᴛᴀʀᴛᴇᴅ...⏳\n𝐁𝐎𝐓 𝐌𝐀𝐃𝐄 𝐁𝐘 ❤️ 𝐒𝐀𝐌𝐔𝐑𝐀𝐈 𝐁𝐎𝐓𝐒</code></pre>"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
                    res_file = await helper.download_video(url, cmd, name)
                    filename = res_file
                    await prog.delete(True)
                ...
                await m.reply_text(text=f' [{str(count).zfill(3)}]({link0}) \n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐎𝐓 𝐌𝐀𝐃𝐄 𝐁𝐘✦ `𝐒𝐀𝐌𝐔𝐑𝐀𝐈 𝐁𝐎𝐓𝐒`', disable_web_page_preview=True, reply_markup=BUTTONSMAN)
                count += 1
                time.sleep(3)
                continue
        ...
        await m.reply_text(e)
    await m.reply_text("<pre><code>Converted By ⌈✨『𝐒𝐀𝐌𝐔𝐑𝐀𝐈 𝐁𝐎𝐓𝐒』✨⌋</code></pre>")
